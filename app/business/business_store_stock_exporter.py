...
async def export_business_store_stock(
    ...
    result = {
        ...
        "tabletki_enterprise_code": store.tabletki_enterprise_code,
        "tabletki_branch": store.tabletki_branch,
        "code_mapping_mode": preview.get("code_mapping_mode") or preview.get("summary", {}).get("code_mapping_mode"),
        "identity_mode": preview.get("code_mapping_mode") or preview.get("summary", {}).get("code_mapping_mode"),
